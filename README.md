# nvim-treesitter-queries-wxml

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-wxml/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-wxml/actions/workflows/validate.yml)

Neovim tree-sitter queries for **wxml**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-wxml",
...
- [ ] Changes are scoped to `wxml` — do not include files for other languages
